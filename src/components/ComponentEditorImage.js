...
import ToggleFileInfoImage from "./ToggleFileInfoImage.js";

const ComponentEditorImage = ({ editingType, editingDatas }) => {
  ...
  useEffect(() => {
    setDatas({
      ...
      watermark: editingDatas.ATTRIBUTE.WATERMARK,
...
export default ComponentEditorImage;
